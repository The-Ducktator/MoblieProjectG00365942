...
export class Tab1Page {
  ...
  factoin: object[] =
  [{name: "UNSC"}, {races: "Humans"}, {info: "The United Nations Space Command is the governing body of the Halo universe. Following the wars of present-day Earth, the UN reforms into the UNSC once extraterrestrial human colonies are established. The military makes up only a small part of the organization, though it's the most explored branch within the Halo lore."}, {line: "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"},
  ...
  {name: "FLOOD"}, {races: "Flood"}, {info: "There is only one threat to humanity greater than that of the Covenant, and it is called the Flood. The parasitic species kills and rewrites its host's DNA upon infection, then uses its new form to spread the infection further. While the Flood's combat forms are similar to zombies, they're also faster, stronger and deadlier than any shambler ever could be."},{line: "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"},
  {name: "FORERUNNERS"}, {races: "Forerunners"}, {info: "For a long, long time, little was known about the Forerunners. They were an ancient, galaxy-spanning empire with access to technology beyond humanity's wildest imaginiation until they disappeared from the galaxy without a trace. All that remains are ancient relics and long-forgotten weapons from another age ..."},{line: "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"},
